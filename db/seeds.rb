...
Station.create(
  ...
  type: "passageiros e pesados",
  brand: "Galp",
  services: ["Lavagem Auto", "WC", "ATM", "Loja Tangerina", "Visa", "Multibanco"],
  schedule: "2ª: 9-20, 3ª 9-20",
  fuel_types: ["gasoleo_simples", "gasoleo_especial", "gasolina_especial_95", "gasolina_simples_95", "gasolina_especial_98"],
  price: {
...
Station.create(
  ...
  services: ["Lavagem Auto", "WC", "ATM", "Loja Tangerina", "Visa", "Multibanco"],
  schedule: "2ª: 9-20, 3ª 9-20",
  fuel_types: ["gasoleo_simples", "gasoleo_especial", "gasolina_especial_95", "gasolina_simples_95", "biodiesel_b15"],
  price: {
...
Station.create(
  ...
  type: "passageiros e pesados",
  brand: "Shell",
  services: ["Acessibilidade", "Ar-Agua", "Gas 9kg", "Loja Conveniencia", "Lubrificantes", "Wifi-gratuito"],
  schedule: "2ª: 7-23, 3ª 7-23",
  fuel_types: ["gasoleo_simples", "gasoleo_especial", "gasolina_especial_95", "gasolina_simples_95"],
  price: {
...
Station.create(
  ...
  type: "passageiros e pesados",
  brand: "Prio",
  services: ["Acessibilidade", "WC", "Atendimento", "Ar-Agua", "Loja Conveniencia", "Lubrificantes"],
  schedule: "2ª: 7-23, 3ª 7-23",
  fuel_types: ["gasoleo_simples", "gasoleo_especial", "gasolina_especial_95", "gasolina_simples_95"],
  price: {
    gasoleo_simples: 1.6890,
...
Station.create(
  ...
  type: "passageiros e pesados",
  brand: "Cepsa",
  services: ["Loja", "Lavagem Auto", "Ar-Agua"],
...
Station.create(
  ...
  fuel_types: ["gasoleo_simples", "gasoleo_especial", "gasóleo colorido", "gasolina_especial_95", "gasolina_simples_95", "gasolina_especial_98", "gasolina_mistura"],
  price: {
